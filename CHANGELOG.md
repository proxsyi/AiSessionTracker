...
- Kept Settings in front while using the menu bar, preserved normal outside-click dismissal, and retained the verified one-press Command-I behavior.
- Standardized live-account Codex and ChatGPT usage, provider alerts, and credential controls while removing counters that are not backed by server data.
